function GeoSensor0106Nexus7matlab = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   GEOSENSOR0106NEXUS7MATLAB = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   GEOSENSOR0106NEXUS7MATLAB = IMPORTFILE(FILENAME, STARTROW, ENDROW)
...
% Auto-generated by MATLAB on 2017/06/03 14:42:15
...
for col=[1,7,13,19]% Convert the contents of columns with dates to MATLAB datetimes using the specified date format.
    try
        dates{col} = datetime(dataArray{col}, 'Format', 'yyyy-MM-dd HH:mm:ss', 'InputFormat', 'yyyy-MM-dd HH:mm:ss'); %#ok<AGROW>
    catch
        try
